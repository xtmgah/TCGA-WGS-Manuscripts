...
```
<div align="center"><img src="./Figures/Fig2b_1.png" width="80%" /></div>
<div align="center"><img src="./Figures/Fig2b_2.png" width="80%" /></div>
<div align="center"><img src="./Figures/Fig2b_3.png" width="80%" /></div>
<div align="center"><img src="./Figures/Fig2b_4.png" width="80%" /></div>
#Fig.2b, Genome-wide profiles of structural variant (SV) breakpoints across UCEC molecular subtypes. SV breakpoint density is shown as the number of breakpoints per 5 Mb window, averaged across tumors within each subtype (POLE, MSI, CN-High, and CN-Low), and plotted along chromosomal coordinates.
...
```
<div align="center"><img src="./Figures/Fig2c.png" width="80%" /></div>
#Fig.2c Summary of focal amplification architectures detected across molecular subtypes. Bars indicate the number of tumors harboring focal amplification events classified as linear, extrachromosomal DNA (ecDNA), breakage-fusion-bridge (BFB), or complex non-cyclic structures, stratified by subtype.
...
```
<div align="center"><img src="./Figures/Fig2f.png" width="30%" /></div>
#Fig.2f, Frequency of chromothripsis events across molecular subtypes. Stacked bars indicate the percentage of tumors with chromothripsis, stratified by confidence level (high or low) based on established detection criteria.
