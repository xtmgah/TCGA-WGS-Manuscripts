# Cohort-specific MATH panels. Reused in Supplementary Fig. 3.
# Source: TP_Comparision.R:2363–2387,2461–2534.
run_ExtendedDataFig2 <- function(input_dir,output_dir,prefix='ExtendedDataFig2',figure_label='Extended Data Fig. 2') {
  ...
  # Select significant alterations across any cohort, as in original code.
