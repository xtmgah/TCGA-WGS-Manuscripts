# Genome-wide CN frequency method from TP_bb_heatmap_freq.R:46-327.
# Only the active SCNA branch is retained; unplotted LOH/debug code removed.
# The historical manual clone/subclone switch is an explicit state parameter.
# Relative CN bins, centromere treatment, CNTools mean and chr21 filtering
# are preserved. This resolves execution state, not proof of the final generator.
