# Cohort comparison helper extracted from Sherlock_functions.R:163-473.
# Scientific behavior: pairwise Wilcoxon tests, BH adjustment, optional facet
# adjustment, scaled jitter seed 1, original boxplots and summaries retained.
# Cleaning: removed debug prints/comments; fixed unused p_override data-frame
# name typo; replaced style with ptc_theme and set readable annotation typography.
# Caller libraries: dplyr, ggplot2, rlang. Other dependencies are namespaced.
# This helper creates no input files and defaults to no export.
